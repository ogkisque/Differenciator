...
#define _TG(left, right)        create_node (FUNC,  SIN,            NULL, left, right)
#define _ARCSIN(left, right)    create_node (FUNC,  SIN,            NULL, left, right)
#define _ARCCOS(left, right)    create_node (FUNC,  SIN,            NULL, left, right)
#define _ARCTG(left, right)     create_node (FUNC,  SIN,            NULL, left, right)
